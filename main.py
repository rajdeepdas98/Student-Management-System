...
class th1(Thread):
    ...
    def run(self):
            ...
            if s1 == 'Rajdeep' and s2 == 'Das':
                class th3(Thread):
                    def run(self):
                        ...
                        l3 = Label(top1, text="Copyright @ Manish Kumar & Team", fg='Blue').place(x=20, y=380)

                        cour=['B.Tech','M.Tech','BSA','MCA','DCA','MBA','LAW']
                        sem=['1st','2nd','3rd','4th','5th','6th','7th','8th']
                        coun=['India','Nepal','Bhutan','Afganistan','Other']
                        bat=['2019 Onwards','2020 Onwards','2021 Onwards']
        ...
        l3 = Label(root, text="Copyright @ Rajdeep Das and Team", fg='Blue').place(x=250, y=380)
